		...
		<div class="features">
			<ul class="features__list">
				<li class="features__item">
					<h3 class="features__title"><span class="features__span">fresh from</span> naturix farm</h3>
					<p class="features__text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
					<button class="features__btn">Read more</button>
				</li>
				<li class="features__item">
					<h3 class="features__title"><span class="features__span">100%</span> organic goods</h3>
					<p class="features__text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
					<button class="features__btn">Read more</button>
				</li>
				<li class="features__item">
					<h3 class="features__title"><span class="features__span">premium</span> quality</h3>
					<p class="features__text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
					<button class="features__btn">Read more</button>
				</li>
				<li class="features__item">
					<h3 class="features__title"><span class="features__span">100%</span> natural</h3>
					<p class="features__text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy.</p>
					<button class="features__btn">Read more</button>
				</li>
			</ul>
			<img class="about__img" src="../assets/big-orangess.png" alt="">
		</div>
	</section>
</template>
